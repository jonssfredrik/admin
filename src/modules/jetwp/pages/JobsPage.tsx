              ...
              return (
                <tr key={job.id} className="group transition-colors hover:bg-bg/60">
                  <td className="border-b border-border/60 px-4 py-3">
                    <Link href={`/jetwp/jobs/${job.id}`} className="font-mono text-[12px] font-medium hover:text-fg">{job.id}</Link>
                  ...
                  <td className="border-b border-border/60 px-4 py-3">
                    <Link href={`/jetwp/${job.siteId}`} className="text-[13px] hover:text-fg">{siteName(job.siteId)}</Link>
