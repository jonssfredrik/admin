      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <Card className="p-5">
          ...
          <div className="space-y-2.5">
            ...
            <HealthRow ok label="SSL" detail={`${site.sslDays} dagar kvar`} warn={site.sslDays < 30} />
            <HealthRow ok label="Incheckning" detail={site.lastHeartbeat} warn={site.heartbeatStale} />
            <HealthRow ok label="Säkerhetskopia" detail={`Senaste säkerhetskopian ${site.lastBackup}`} />
