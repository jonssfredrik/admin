...
export function SourcesPage() {
  ...
  const total = feedSources.reduce((s, f) => s + f.domainsLastRun, 0);
  const active = feedSources.filter((f) => f.status === "active").length;
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <Card>
          ...
          <div className="mt-2 text-2xl font-semibold tabular-nums">{active}/{feedSources.length}</div>
