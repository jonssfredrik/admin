...
export const notificationChannels: NotificationChannel[] = [
  { id: "ch-1", name: "Ops Slack", type: "slack", target: "#mwp-ops", status: "active", scope: "global" },
  { id: "ch-2", name: "Security Mail", type: "email", target: "security@example.se", status: "active", scope: "global" },
  { id: "ch-3", name: "Lagom Webhook", type: "webhook", target: "https://lagom.example/hooks/mwp", status: "degraded", scope: "site", siteId: "site-2" },
];
