...
const onboarding: WorkflowTemplate = {
  ...
  nodes: [
    ...
    },
    {
      ...
      kind: "guardrail",
      icon: Shield,
      title: "Krav pa gron status",
      subtitle: "Alla kontroller maste vara godkanda",
      x: 980,
      y: 90,
      config: [{ label: "Krav", value: "health=ok" }],
    },
    {
      id: "n6",
      kind: "tool",
    ...
    },
    {
      ...
      x: 1280,
      y: 350,
      config: [{ label: "Kanal", value: "#mwp-ops" }],
    },
  ],
  edges: [
    { id: "e1", from: "n1", to: "n2" },
...
const pluginUpdates: WorkflowTemplate = {
  ...
  description: "Validera → uppdatera → smoke test → rollback vid fel",
  status: "active",
  ...
  nodes: [
    ...
    { id: "n2", kind: "tool", icon: Plug, title: "Hämta plugins m. update", subtitle: "wp-cli plugin list --update=available", x: 340, y: 220 },
    {
      ...
      kind: "guardrail",
      icon: Shield,
      title: "Validera fore andring",
      subtitle: "Kontrollera status innan utrullning",
      x: 640,
      y: 220,
      config: [{ label: "Krav", value: "health + telemetry" }, { label: "Timeout", value: "30s" }],
    },
    ...
    { id: "n6", kind: "logic", icon: GitBranch, title: "Allt OK?", subtitle: "If status === 200", x: 1540, y: 220 },
    {
      ...
      icon: RotateCw,
      title: "Rollback",
      subtitle: "Rulla tillbaka senaste andring",
      x: 1840,
      y: 90,
      config: [{ label: "Kalla", value: "senaste releasepunkt" }],
    },
    { id: "n8", kind: "output", icon: Bell, title: "Larmrapport", subtitle: "Slack · #mwp-ops", x: 1840, y: 350 },
    { id: "n9", kind: "output", icon: Bell, title: "OK-rapport", subtitle: "Slack · #mwp-ops", x: 2140, y: 220 },
  ],
  edges: [
    { id: "e1", from: "n1", to: "n2" },
    { id: "e2", from: "n2", to: "n3" },
...
const sslRenewal: WorkflowTemplate = {
  ...
  nodes: [
    { id: "n1", kind: "trigger", icon: Clock, title: "Dagligen 08:00", subtitle: "Cron · 0 8 * * *", x: 40, y: 220 },
    {
      ...
      subtitle: "För alla sajter i MWP",
      x: 340,
      y: 220,
...
const uptimeAlert: WorkflowTemplate = {
  ...
  nodes: [
    ...
    { id: "n5", kind: "output", icon: Bell, title: "Slack-larm", subtitle: "#mwp-ops · @oncall", x: 1240, y: 220 },
  ],
  edges: [
    { id: "e1", from: "n1", to: "n2" },
    { id: "e2", from: "n2", to: "n3" },
