...
const installModes = [
  {
    ...
    description: "MWP provisionerar databas, SSL, baseline-hardening och agent automatiskt.",
  },
  {
    id: "pair",
...
export function AddSiteDialog({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <Dialog
      ...
      description={
        step === 1 ? "Registrera grunddata för den sajt som ska in i MWP." : "Välj hur sajten ska provisioneras och driftas."
      }
      size="xl"
      footer={
        step === 1 ? (
            ...
            <ul className="mt-2 space-y-1.5 text-sm text-muted">
              ...
              <li>
                {installMode === "pair"
                  ...
                  : "MWP provisionerar en ny WordPress-installation i vald region."}
              </li>
            </ul>
          </div>
        </div>
