...
import { AddSiteDialog } from "@/modules/mwp/components/AddSiteDialog";
...
import { jobs, alerts, pluginInventory, themeInventory, coreInventory } from "@/modules/mwp/fleet/core";
import { fleetHealthTrend, fleetRegions } from "@/modules/mwp/extended-data/core";
import { getOverviewStats } from "@/modules/mwp/selectors/overview";

export default function MWPOverviewPage() {
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <Card className="p-5 lg:col-span-2">
          <div className="mb-4 flex items-center justify-between">
            ...
            <Link href="/mwp/sites" className="inline-flex items-center gap-1 text-xs text-muted hover:text-fg">
        ...
        <div className="space-y-4">
          <Card className="p-5">
            <div className="mb-3 flex items-center justify-between">
              ...
              <Link href="/mwp/health" className="text-xs text-muted hover:text-fg">Detaljer →</Link>
            </div>
          ...
          <Card className="p-5">
            <div className="mb-3 flex items-center justify-between">
              ...
              <Link href="/mwp/jobs" className="text-xs text-muted hover:text-fg">Detaljer →</Link>
            </div>
            <div className="space-y-2.5 text-sm">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <Card className="overflow-hidden p-0">
          <div className="flex items-center justify-between border-b px-5 py-3">
            ...
            <Link href="/mwp/alerts" className="text-xs text-muted hover:text-fg">Visa alla →</Link>
          </div>
        ...
        <Card className="overflow-hidden p-0">
          <div className="flex items-center justify-between border-b px-5 py-3">
            ...
            <Link href="/mwp/inventory" className="text-xs text-muted hover:text-fg">Detaljer →</Link>
          </div>
          <div className="divide-y divide-border/60">
        ...
        <div className="divide-y divide-border/60">
          {jobs.slice(0, 6).map((job) => (
            <div key={job.id} className="flex items-center gap-3 px-5 py-2.5 text-sm">
              ...
              <Link href={`/mwp/${job.siteId}`} className="shrink-0 text-xs text-muted hover:text-fg">{sites.find((s) => s.id === job.siteId)?.domain}</Link>
...
function SiteRow({ site }: { site: typeof sites[number] }) {
  ...
  return (
    <Link href={`/mwp/${site.id}`} className="flex items-center gap-3 rounded-lg px-2.5 py-2 transition-colors hover:bg-bg">
