...
import { getSiteRecord } from "@/modules/mwp/data";
import { SiteDetailHeader } from "@/modules/mwp/site-detail/SiteDetailHeader";
import { OverviewTab } from "@/modules/mwp/site-detail/OverviewTab";
import { PluginsTab } from "@/modules/mwp/site-detail/PluginsTab";
import { ThemesTab } from "@/modules/mwp/site-detail/ThemesTab";
import { DomainsTab } from "@/modules/mwp/site-detail/DomainsTab";
import { LogsTab } from "@/modules/mwp/site-detail/LogsTab";
import { SettingsTab } from "@/modules/mwp/site-detail/SettingsTab";
import {
  getSiteOverviewModel,
  isSiteDetailTab,
  type SiteDetailTabId,
} from "@/modules/mwp/selectors/site-detail";
import { useMockActionState, waitForMockAction } from "@/modules/mwp/lib/useMockActionState";
...
export default function SiteDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const selectTab = (nextTab: SiteDetailTabId) => {
    ...
    router.replace(query ? `/mwp/${id}?${query}` : `/mwp/${id}`);
  };
  ...
  const overview = getSiteOverviewModel(site);
