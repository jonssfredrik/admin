  ...
  if (!job) {
    return (
      <div className="space-y-6">
        <Link href="/mwp/jobs" className="inline-flex items-center gap-1 text-xs text-muted hover:text-fg">
          <ArrowLeft size={12} />
          Jobb
        </Link>
        ...
        <div className="space-y-4 lg:col-span-2">
          ...
          <Card className="overflow-hidden p-0">
            ...
            <div className="divide-y divide-border/60">
              {related.map((entry) => (
                <Link key={entry.id} href={`/mwp/jobs/${entry.id}`} className="flex items-center gap-3 px-5 py-2.5 text-sm transition-colors hover:bg-bg/60">
        ...
        <div className="space-y-4">
          ...
          {job.workflow && (
            <Card className="p-5">
              ...
              <Link href={`/mwp/workflow/${job.workflow.id}`} className="mt-2 flex items-center justify-between rounded-lg border bg-bg/40 px-3 py-2 transition-colors hover:bg-bg">
                <div>
          ...
          <Card className="p-5">
            ...
            <Link href={`/mwp/${job.siteId}`} className="mt-2 flex items-center justify-between rounded-lg border bg-bg/40 px-3 py-2 transition-colors hover:bg-bg">
              <div>
            ...
            <Button variant="secondary" className="mt-3 w-full" onClick={() => router.push(`/mwp/jobs/new?site=${job.siteId}`)}>
