  ...
  const filtered = useMemo(() => {
    ...
    return items.filter((alert) => {
      ...
      return (
        ...
        alert.comments.some((comment) => comment.body.toLowerCase().includes(q)) ||
        (alert.siteId && siteName(alert.siteId).toLowerCase().includes(q))
      );
    });
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="ml-auto flex gap-2">
            <Button
              ...
              onClick={() => {
                ...
                toast.success("Alla äppna alerts ackade");
              }}
            >
      ...
      <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-1.5 flex items-center gap-3 text-[11px] text-muted">
                    ...
                    {alert.siteId && (
                      <Link href={`/jetwp/${alert.siteId}`} className="hover:text-fg">
                  ...
                  {latestComment && (
                    <div className="mt-3 overflow-hidden rounded-xl border bg-surface/90 shadow-soft">
                      ...
                      <div className="px-3 py-3">
                        <div className="text-sm leading-6 text-fg/90">
                          {latestComment.body}
                        </div>
        ...
        {filtered.length === 0 && (
          <Card className="p-10 text-center text-sm text-muted">Inga alerts matchade filtret.</Card>
        )}
      </div>
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Beskriv vad som gjordes, om någon åtgard togs eller varför alerten kan stöngas."
