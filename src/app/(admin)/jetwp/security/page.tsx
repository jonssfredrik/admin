...
import { ArrowLeft, ShieldAlert, RefreshCw, Wrench } from "lucide-react";
    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="mt-3 flex items-start justify-between gap-4">
          <PageHeader title="Security" subtitle="Vulnerability scanner, CVEs and remediation flow per site." />
